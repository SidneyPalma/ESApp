class Application < Netzke::Basepack::Viewport
  ...
  class User < Struct.new(:email, :password)
    def initialize
      self.email = "teste@espacoalpha.org.br"
  ...
  def configure(c)
    super
    c.intro_html = "Clique em um dos itens na arvore de controle ao lado!!"
    c.items = [
      { layout: :border,
...
#  end
  ...
  component :tipoclasses do |c|
    c.title  = "Tipo Classes"
    c.desc = " Tipo de Classe"
  end
  ...
  component :unidades_com_alunos do |c|
    c.title  = "Unidades com Alunos"
  ...
  def header_html
    %Q{
      <div style="color:#333; font-family: Helvetica; font-size: 150%;">
        <a style="color:#B32D15;" href="http://www.iasdalphavillemanaus.org.br/" target="_blank">EspacoAlpha</a> ES App v0.01
      </div>
    }
  end

...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { Batismo: @aluno.Batismo, Email: @aluno.Email, Endereco: @aluno.Endereco, Fone: @aluno.Fone, Nascimento: @aluno.Nascimento, Nome: @aluno.Nome }
    end
  ...
  test "should update aluno" do
    put :update, id: @aluno, aluno: { Batismo: @aluno.Batismo, Email: @aluno.Email, Endereco: @aluno.Endereco, Fone: @aluno.Fone, Nascimento: @aluno.Nascimento, Nome: @aluno.Nome }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
